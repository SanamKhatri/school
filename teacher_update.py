...
def update_teacher():
    ...
    if update_choice==1:
        ...
        teacher_object = Teacher(name=None, address=update_address, contact_no=None, salary=None, subject=None, sex=None)
        teacher_object.set(teacher_deatail[0])
        ...
        teacher_object = Teacher(name=None, address=None, contact_no=update_contact, salary=None, subject=None, sex=None)
        teacher_object.set(teacher_deatail[0])
